let player = {
    ...
    get_shuffled_list: function () {
        ...
        playlist.play_next = function (spot) {
            ...
            player.yt_player_iframe.setAttribute('src','https://www.youtube.com/embed/' + player.now_playing.id + '?enablejsapi=1&autoplay=1&start=' + (player.now_playing.start || 0) + ((player.now_playing.stop) ? '&end=' + player.now_playing.stop : ''));
